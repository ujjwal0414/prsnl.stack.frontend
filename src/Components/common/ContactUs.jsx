          ...
          <form className='flex flex-col gap-[2.5vh]'>
            ...
            <div className='pt-[2vh] border-t border-[#F3F4F6] flex justify-end'>
              <button 
                ...
                className='bg-[#55828b] hover:bg-[#466d75] text-white px-10 py-[0.8rem] rounded-xl font-bold flex items-center gap-[0.6rem] transition-all duration-300 active:scale-95 shadow-sm shadow-[#55828b]/20'
              >
                Send Message
